...
class Coref(object):
    ...
    def run_coref_on_mentions(self, mentions):
        ...
        for feature in FEATURES_NAMES[:9]:
            print("Building numpy array for", feature)
            print("feature dict is ,",gathering_dict[feature])
            print("length", len(gathering_dict[feature]))
        ...
        for i in range(len(mention_feature_dict[FEATURES_NAMES[0]])) :
            ...
            single_inputs = (spans, words, features)
            ...
            pairs_inputs = (spans, words, features,ant_spans, ant_words,ana_spans, ana_words,pairs_features)
